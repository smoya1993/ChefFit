    ...
    <section className="box h-[82vh] flex flex-col-reverse md:flex-row justify-between gap-8 md:gap-16">
      <div className="flex flex-col items-center md:items-start justify-center basis-1/2 gap-4">
        ...
        <h2 className="font-bold text-3xl md:text-5xl text-center md:text-start">
          Bienvenido a <span className="text-primary">Cheffit</span>
        </h2>
        <p className="text-gray-600 text-center md:text-start">
          Donde los amantes de la comida se unen para descubrir recetas deliciosas, restaurantes encantadores y discusiones sobre comida. Explora, comparte y conecta a través de la alegría de cocinar y cenar.
        </p>
        <Link to={"/recipe"}>
          <Button
            content={"Explorar Recetas"}
            customCss={
